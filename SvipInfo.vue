<template>
    <div class="app-newsinfo">
        <!--新闻详情-->
        <div class="mui-card">
            <div class="mui-card-header mui-card-media" :style="'height:100vw;background-image:url('+info.img_url+')'"></div>
        ...
        <div class="mui-card">
            ...
            <div class="mui-card-content">
                <div class="mui-card-content-inner">
                    ...
                    <mt-button size="large" type="primary" @click="addComment" style="background:#f90">发表评论</mt-button>
                </div>
            </div>
            ...
            <div class="mui-card-content">
                <div class="mui-card-content-inner">
                    <div class="cmt-list">
                        ...
                        <mt-button size="large" @click="loadMore" type="primary" style="background:#f90">下一页</mt-button>
                    </div>
                </div>
            </div>
        </div>
    ...
    export default {
        ...
        methods:{
            ...
            findNewsInfo(){
                ...
                var id=this.nid;
                //2:创建url保存请求地址
                var url="http://127.0.0.1:3000/SvipInfo?nid="+id;
                //3:发送ajax请求
                this.axios.get(url).then(result=>{
                    //4:获取服务器返回数据保存 info  
                    this.info=result.data.data[0];  //0是为了取到数组下标0
